...
public class AllowanceDetailsReader {
    ...
    /** Returns the {@link Allowance} for the given employee ID, or {@code null} if not found. */
    public Allowance getAllowance(String empId) {
        if (cache == null) loadCache();
        return cache.get(empId.trim());
    }

    /** Returns an unmodifiable view of all allowance entries (empId → Allowance). */
    public Map<String, Allowance> getAllAllowances() {
        if (cache == null) loadCache();
        return Collections.unmodifiableMap(cache);
    }

    /** Appends a new allowance row for the given employee ID. */
    ...
    /** Updates the allowance row for the given employee ID. */
    ...
    /** Removes the allowance row for the given employee ID. */
